...
public sealed partial class BreakOffRelationsHandler
{
    ...
    [GeneratedRegex(@$"^{BotCommands.BreakOffRelations}(?:@(?<botname>[A-Za-z0-9_]+))?\s+(?<alias>[A-Za-z0-9_]+)$", RegexOptions.Compiled | RegexOptions.Singleline | RegexOptions.CultureInvariant | RegexOptions.NonBacktracking, 500)]
